...
d = '/temp/srd1g10/results/24c/mesons/0.005_0.0613/pickled.dispersion/'
folders = [d+'p0/', d+'p2/']
fit_ranges = [(8, 31), (8, 25)]
guesses = [0.38, 0.51]
names = ['p0', 'p1']
jl = []
...
def get_c():
    ...
    m_2 = masses * masses
    L = 24
    c = (m_2[1] - m_2[0])/ (( 2 * np.pi / L ) ** 2 * 2) # central
    cjl = (jl_2[1] - jl_2[0])/ (( 2 * np.pi / L ) ** 2 * 2) # jackknife
